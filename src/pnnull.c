...
pn_object *PnNull_ToString(pn_world *world, pn_object *object, pn_object *params[], int length)
{
    PN_ASSERT(length == 0);
    return PnString_Create(world, "(null)");
}

pn_object *PnNull_Create(pn_world *world)
{
...
pn_object *PnNull_CreatePrototype(pn_world *world)
{
