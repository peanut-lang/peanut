...
static pn_object *
__concatenate_strings(pn_world *world, pn_object *object, pn_object *other)
{
...
pn_object *
PnString_Add(pn_world *world, pn_object *object, pn_object *params[], int length)
{
	PN_ASSERT(length == 1);
...
static pn_object *
PnString_Mult(pn_world *world, pn_object *object, pn_object *params[], int length)
{
	PN_ASSERT(length == 1);
	pn_object *other = params[0];
...
static pn_object *
PnString_ToInteger(pn_world *world, pn_object *object, pn_object *params[], int length)
{
	PN_ASSERT(length == 0);
	// TODO: 추후에 sscanf 로 바꿔서 예외처리 필요
...
static pn_object *
PnString_ToReal(pn_world *world, pn_object *object, pn_object *params[], int length)
{
	PN_ASSERT(length == 0);
	// TODO: 추후에 sscanf 로 바꿔서 예외처리 필요
...
static pn_object *
PnString_Substring(pn_world *world, pn_object *object, pn_object *params[], int length)
{
	PN_ASSERT(length == 2);
...
static pn_object *
PnString_Reverse(pn_world *world, pn_object *object, pn_object *params[], int length)
{
	PN_ASSERT(length == 0);
	int i;
	int str_length = strlen(object->str_val);
...
static pn_object *
PnString_ToString(pn_world *world, pn_object *object, pn_object *params[], int length)
{
	PN_ASSERT(length == 0);
...
pn_object *
PnString_Create(pn_world *world, char *str)
{
...
pn_object *
PnString_CreatePrototype(pn_world *world)
{
