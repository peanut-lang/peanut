...
static pn_object *
PnHash_GetItem(pn_world *world, pn_object *object, pn_object *params[], int length)
{
...
static pn_object *
PnHash_PutItem(pn_world *world, pn_object *object, pn_object *params[], int length)
{
	PN_ASSERT(world != NULL);
	PN_ASSERT(object != NULL);
	PN_ASSERT(object->obj_val->extra_val != NULL);
...
static pn_object *
PnHash_AddHash(pn_world *world, pn_object *object, pn_object *params[], int length)
{
	PN_ASSERT(world != NULL);
	PN_ASSERT(object != NULL);
	PN_ASSERT(object->obj_val->extra_val != NULL);
...
static pn_object *
PnHash_RemoveItem(pn_world *world, pn_object *object, pn_object *params[], int length)
{
	PN_ASSERT(world != NULL);
	PN_ASSERT(object != NULL);
	PN_ASSERT(object->obj_val->extra_val != NULL);
...
static pn_object *
PnHash_Clear(pn_world *world, pn_object *object, pn_object *params[], int length)
{
	PN_ASSERT(world != NULL);
	PN_ASSERT(object != NULL);
	PN_ASSERT(object->obj_val->extra_val != NULL);
...
static pn_object *
PnHash_IsEmpty(pn_world *world, pn_object *object, pn_object *params[], int length)
{
	PN_ASSERT(world != NULL);
	PN_ASSERT(object != NULL);
	PN_ASSERT(object->obj_val->extra_val != NULL);
...
static pn_object *
PnHash_ToString(pn_world *world, pn_object *object, pn_object *params[], int length)
{
	PN_ASSERT(world != NULL);
	PN_ASSERT(object != NULL);
	PN_ASSERT(object->obj_val->extra_val != NULL);
...
static pn_object *
PnHash_Delete(pn_world *world, pn_object *object, pn_object *params[], int length)
{
	PN_ASSERT(world != NULL);
	PN_ASSERT(object != NULL);
	PN_ASSERT(length == 0);
...
static pn_object *
PnHash_Keys(pn_world *world, pn_object *object, pn_object *params[], int length)
{
	PN_ASSERT(world != NULL);
	PN_ASSERT(object != NULL);
	PN_ASSERT(length == 0);
...
static pn_object *
PnHash_Values(pn_world *world, pn_object *object, pn_object *params[], int length)
{
	PN_ASSERT(world != NULL);
	PN_ASSERT(object != NULL);
	PN_ASSERT(length == 0);
...
pn_object *
PnHash_CreatePrototype(pn_world *world)
{
