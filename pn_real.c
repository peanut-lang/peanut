...
static pn_object *
PnReal_Add(pn_world *world, pn_object *object, pn_object *params[], int length)
{
	PN_ASSERT(length == 1);
...
static pn_object *
PnReal_Sub(pn_world *world, pn_object *object, pn_object *params[], int length)
{
	PN_ASSERT(length == 1);
	pn_object *other = params[0];
	pn_object *result = NULL;
...
static pn_object *
PnReal_Mult(pn_world *world, pn_object *object, pn_object *params[], int length)
{
	PN_ASSERT(length == 1);
	pn_object *other = params[0];
	pn_object *result = NULL;
...
static pn_object *
PnReal_Div(pn_world *world, pn_object *object, pn_object *params[], int length)
{
	PN_ASSERT(length == 1);
	pn_object *other = params[0];
	pn_object *result = NULL;
...
static pn_object *
PnReal_Mod(pn_world *world, pn_object *object, pn_object *params[], int length)
{
	PN_ASSERT(length == 1);
	pn_object *other = params[0];
	pn_object *result = NULL;
...
static pn_object *
PnReal_ToString(pn_world *world, pn_object *object, pn_object *params[], int length)
{
	PN_ASSERT(length == 0);
	char ch[101]; // TODO: 최대 100자리? 자릿수 계산 필요
	sprintf(ch, "%.10f", object->real_val); // TODO: 소숫점 및 최대 10자리
...
static pn_object *
PnReal_Eqfn(pn_world *world, pn_object *object, pn_object *params[], int length)
{
	PN_ASSERT(length == 1);
...
static pn_object *
PnReal_Ltfn(pn_world *world, pn_object *object, pn_object *params[], int length)
{
	PN_ASSERT(length == 1);
	pn_object *result = PnObject_CreateInteger(0);
	pn_object *other = params[0];
...
pn_object *
PnReal_Create(pn_world *world, double value)
{
...
pn_object *
PnReal_CreatePrototype(pn_world *world)
{
