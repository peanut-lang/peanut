...
static pn_object *
PnInteger_Add(pn_world *world, pn_object *object, pn_object *params[], int length)
{
	PN_ASSERT(length == 1);
...
static pn_object *
PnInteger_Sub(pn_world *world, pn_object *object, pn_object *params[], int length)
{
	PN_ASSERT(length == 1);
	pn_object *other = params[0];
	pn_object *result = NULL;
...
static pn_object *
PnInteger_Mult(pn_world *world, pn_object *object, pn_object *params[], int length)
{
	PN_ASSERT(length == 1);
	pn_object *other = params[0];
	pn_object *result = NULL;
...
static pn_object *
PnInteger_Div(pn_world *world, pn_object *object, pn_object *params[], int length)
{
	PN_ASSERT(length == 1);
	pn_object *other = params[0];
	pn_object *result = NULL;
...
static pn_object *
PnInteger_Mod(pn_world *world, pn_object *object, pn_object *params[], int length)
{
	PN_ASSERT(length == 1);
	pn_object *other = params[0];
	pn_object *result = NULL;
...
static pn_object *
PnInteger_ToString(pn_world *world, pn_object *object, pn_object *params[], int length)
{
	PN_ASSERT(length == 0);
	char *s = pn_alloc(sizeof(char) * 11);	// 최대 11자리
...
static pn_object *
PnInteger_Eqfn(pn_world *world, pn_object *object, pn_object *params[], int length)
{
	PN_ASSERT(length == 1);
...
static pn_object *
PnInteger_NEqfn(pn_world *world, pn_object *object, pn_object *params[], int length)
{
	PN_ASSERT(length == 1);
	pn_object *result = PnInteger_Create(world, 0);
	pn_object *other = params[0];
...
pn_object *
PnInteger_Create(pn_world *world, int value)
{
...
pn_object *
PnInteger_CreatePrototype(pn_world *world)
{
