...
pn_object *
PnFunction_CreateByNative(pn_world *world, pn_function_native func_body)
{
...
/**
 * func_code는 함수 내용의 노드가 아니고 함수 자체 노드를 입력 받는다.
 */
pn_object *
PnFunction_CreateByNode(pn_world *world, pn_node *func_code)
{
	pn_object *obj = PnObject_CreateEmptyObjectByNotMembers(world);
...
pn_object *
PnFunction_ExecuteByObject(const char *name, pn_world *world, pn_object *object, pn_object *params[], int length)
{
...
pn_object *
PnFunction_ExecuteByFuncObject(pn_object* pn_func, pn_world *world, pn_object *object, pn_object *params[], int length)
{
	PN_ASSERT(pn_func != NULL);
